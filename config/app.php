...
return [
    ...
    */
    ...
    'providers' => [
         ...
         */
        Gestao\Providers\AppServiceProvider::class,
        Gestao\Providers\AuthServiceProvider::class,
        // Gestao\Providers\BroadcastServiceProvider::class,
        Gestao\Providers\EventServiceProvider::class,
        Gestao\Providers\RouteServiceProvider::class,
